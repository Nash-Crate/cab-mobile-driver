...
class _$UserModelImpl extends _UserModel  {
  const _$UserModelImpl({required this.id}): super._();
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$UserModelImpl&&(identical(other.id, id) || other.id == id));
}
